...
# Elastic IP for NAT Gateway (optional - costs ~$50/month)
...
# NAT Gateway (optional - costs ~$50/month)
# Allows private subnets to access internet for updates
# Set enable_nat_gateway=false for minimal cost POC
...
# VPC Flow Logs (for debugging and security monitoring)
