...
# ===================================================================
# Creates OIDC identity provider for GitHub Actions and IAM roles
# Dependencies: None (IAM is global)
# ===================================================================
...
# Policy for GitHub Actions to deploy to S3 and invalidate CloudFront
...
# Policy for GitHub Actions to read secrets
resource "aws_iam_role_policy" "github_actions_secrets" {
  name = "${var.project_name}-${var.environment}-github-actions-secrets"
  role = aws_iam_role.github_actions.id
...
# Policy for ECS to read secrets from Secrets Manager
...
# Policy for ECS tasks to access S3 (for file uploads if needed)
...
# Policy for ECS tasks to read database credentials
